angular.module('vbiApp')
	.factory('chartRenderer', [function(){
	...
	var chartLoader = {
		...
		gdpStackedBarChart: function(chartContainer, containerWidth, jsonDataUrl) {
			var promise = new Promise(function(resolve, reject) {
				gdpStackedBarChart(chartContainer, containerWidth, jsonDataUrl, resolve);
			});
			return promise;
		},
		plotContinentChart: function(chartContainer, containerWidth, jsonDataUrl) {
			var promise = new Promise(function() {
				plotContinentChart(chartContainer, containerWidth, jsonDataUrl, resolve);
			});
			return promise;
		},
		gdpPerCapitaBarChart: function(chartContainer, containerWidth, jsonDataUrl) {
			var promise = new Promise(function() {
				gdpPerCapitaBarChart(chartContainer, containerWidth, jsonDataUrl, resolve);
			});
			return promise;
		},
		plotNorthEast: function(chartContainer, containerWidth, jsonDataUrl) {
			var promise = new Promise(function() {
				plotNorthEast(chartContainer, containerWidth, jsonDataUrl, resolve);
			});
			return promise;
		}
	...
	function plotContinentChart (chartContainer, containerWidth, jsonDataUrl, promise){
	...
	function gdpStackedBarChart(chartContainer, containerWidth, jsonDataUrl, promise) {

		
	}

	function gdpPerCapitaBarChart(chartContainer, containerWidth, jsonDataUrl, promise) {
	...
	function plotNorthEast(chartContainer, containerWidth, jsonDataUrl, promise){
		width = containerWidth || width;
		width = containerWidth -margin.left - margin.right;
